    ...
    (function(Apriori) {
        ...
        var Algorithm = (function() {
            ...
            Algorithm.prototype.showAnalysisResult = function(data) {
				...
				// Refer back to this line
				/* stack = new Error(); 
				groups = stack.match("at.*([0-9]+)")
				line_number = groups[groups.length-1]
				console.log("Uncomment the following line to see Apriori results file:///C:/Users/Administrator/Documents/js_arules/app.js:"+line_number)
